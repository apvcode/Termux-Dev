import { AgentConfig, AgentEvent, LLMProvider, Message, PermissionGuard, Tool } from './types.js';
...
export class Agent {
  ...
  async *run(signal?: AbortSignal): AsyncGenerator<AgentEvent, void, unknown> {
    let iterations = 0;
